...
<script type="text/javascript">
	$(function() {
		...
		$(document).on("submit","#f1",function(event) {
			...
			var phone = $("#idtel1").val()+"-"+$("#idtel2").val()+"-"+$("#idtel3").val()
		...
		$(document).on("submit","#f2",function(event) {
			...
			var phone2 = $("#pwtel1").val()+"-"+$("#pwtel2").val()+"-"+$("#pwtel3").val()
		...
		<div id="find">
			...
			<form action="find.do" method="post" id="f1">
				<fieldset id="feldid">
					...
					<p>
						<label>이름 </label> <input type="text" id="name" placeholder="이름 입력" name="name">
					</p>
					<p>
						<label>전화 번호 </label> 
						<select id="idtel1" name="tel1">
							<option value="010">010</option>
							<option value="017">017</option>
							<option value="011">011</option>
							<option value="016">016</option>
						</select> - <input type="tel" id="idtel2" maxlength="4" title="전화번호를 입력하세요." name="tel2"> - <input type="tel" maxlength="4" title="전화번호를 입력하세요."
							id="idtel3"  name="tel3">
					</p>
					<p>
			...
			<form action="find.do" method="post" id="f2">
				<fieldset id="feldpw">
					...
					<p>
						<label>전화 번호 </label> 
						<select id="pwtel1" name="tel1">
							<option value="010">010</option>
							<option value="017">017</option>
							<option value="011">011</option> 
							<option value="016">016</option>
						</select> - <input type="tel" id="pwtel2" maxlength="4" title="전화번호를 입력하세요." name="tel2"> - <input type="tel" maxlength="4" title="전화번호를 입력하세요."
							id="pwtel3"  name="tel3">
					</p>   
					<p>
